...
class TestController extends Controller
{
    ...
    public function pay() {
        //统一下单接口 
        $return = $this->weixin_app();
        return $return;
    }

    //微信小程序接口 (3.调用商户服务器再次签名接口，返回支付数据)
    private function weixin_app() {
        // 统一下单接口
    ...
    private function unifiedorder() {
        ...
        //用来查看服务器返回的结果 测试
        //$date = date('Ymd',time());
        //file_put_contents(APP_ROOT.'/Statics/'.$date.'.txt',$return,FILE_APPEND);
    ...
    private function getSign($Obj) {
        ...
        //签名步骤一：按字典序排序参数 ksort($Parameters);
